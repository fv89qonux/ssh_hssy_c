...
<div class="mian" style="height: 500px">
	...
	private String realName;//真实 -->
	          <form action="login_tores.do" method="post">
              <tr>
                <td width="6%">&nbsp;</td>
              ...
              <tr>
                ...
                <td>
                <input type="password" name="passWord" id="textfield2" /class="yanse"></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td width="6%">&nbsp;</td>
                <td width="31%" align="right" style="color:#000; font-size:14px; line-height:50px; line-height:50px;">电话：</td>
                <td width="57%"><input type="text" name="phone" id="textfield" / class="yanse"></td>
                <td width="6%">&nbsp;</td>
              </tr>
              <tr>
                <td width="6%">&nbsp;</td>
                <td width="31%" align="right" style="color:#000; font-size:14px; line-height:50px; line-height:50px;">真实名称：</td>
                <td width="57%"><input type="text" name="realName" id="textfield" / class="yanse"></td>
                <td width="6%">&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <td><table width="205" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="89"><div class="login"> <input style="background: #FFC815;border: none;" type="submit" value="免费注册" />
                    </div></td>
                    <td width="6">&nbsp;</td>
                    <td width="300"><a href= "login_login.do">已注册请登</a>录</td>
                    <td width="12">&nbsp;</td>
                  </tr>
                </table></td>
                <td>&nbsp;</td>
