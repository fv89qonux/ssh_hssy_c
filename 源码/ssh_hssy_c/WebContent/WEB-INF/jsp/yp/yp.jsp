...
<div class="matter2">
              ...
              <div class="content">
               ...
               <c:forEach items="${pagers.datas}" var="man" varStatus="l">
                 <div class="prod">
                        <div class="tip"><a href="${ctx}/yp_view.do?id=${man.id}"><img src="/ssh_hssy_m/${man.urls}" width="205" height="125" onload="javascript:DrawImage(this,205,125)"></a></div>
                ...
                <div class="digg">
                 ...
                 <pg:pager  url="${ctx}/yp_yp.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="16" export="curPage=pageNumber" >
		<pg:last>  
