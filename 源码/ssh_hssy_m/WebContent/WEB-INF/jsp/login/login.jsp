...
<div class="headers">拾光·印记婚纱摄影管理系统</div>
<div >拾光·印记婚纱摄影管理系统</div>
    ...
    <form class="form form-horizontal" action="login_toLogin.do" method="post">
      ...
      <div class="row cl">
       ...
       <div class="row cl">
        ...
        <div class="formControls col-xs-8">
	        <select id="pid" onchange="gradeChange()" name="type" class="input-text size-L">
			    <option  value="1" selected="selected">超级管理员</a>
			    <option  value="2">普通管理员</a>
		   </select>
        </div>
      </div>
      <div class="row cl">
...
<div class="footer">拾光·印记婚纱摄影管理系统</div>
