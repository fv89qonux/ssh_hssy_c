...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 添加管理 <span class="c-gray en">&gt;
        </span> 样片列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
   ...
   <%-- <div class="text-c"> 
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
	    <span class="l">  
	                      <a href="javascript:;" onclick="admin_add('添加样片','${ctx}/yp_add.do','600','300')" class="btn btn-primary radius">
	                      <i class="Hui-iconfont">&#xe600;</i>  添加样片</a></span>
	                     <span class="r">
	                     <div class="panel-foot text-center">
      <pg:pager  url="${ctx}/yp_yp.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
		<pg:last>  
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
		 ...
		 <tr class="text-c">
				...
				<td class="td-manage">
				 <a title="编辑" href="${ctx }/yp_update.do?id=${man.id}" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function admin_add(title,url,w,h){
	window.location.href=ctx+"/yp_add.do"
}
/*管理员-删除*/
function admin_del(id){
	layer.confirm('确认要删除吗？',function(index){
		...
		window.location.href=ctx+"/yp_delete.do?id="+id;
	});
}
/*管理员-编辑*/
