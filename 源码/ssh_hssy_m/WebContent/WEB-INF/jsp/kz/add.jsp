			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" id="myForm" action="kz_exAdd.do" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label>主图：</label>
									<input class="form-control" type="file" placeholder="请输入名称" name="file">
								</div>	
								
								<div class="form-group">
								<!-- 加载编辑器的容器 -->
							        <script id="remark_txt_1" name="content" type="text/plain" style="width:1000px;height:500px;">${t1['plan']['remark'] }</script>
								    <!-- 实例化编辑器 -->
