			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" id="myForm" action="kz_exUpdate.do" method="post" enctype="multipart/form-data">
							 <input type="hidden" name="id" value="${Obj.id}"> 
								<div class="form-group">
									<label>名称：</label>
									<input class="form-control" placeholder="请输入名称" name="name" value="${Obj.name }">
								</div>
								<div class="form-group">
									<label>主图：</label>
